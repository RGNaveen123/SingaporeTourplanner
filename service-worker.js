// Bump this version string every time app.jsx changes, in lockstep with the
// ?v= query param in index.html — this forces a full cache replacement
// instead of relying on network-first alone to notice new bytes.
const CACHE = "sgtp-shell-v4";
const SHELL = ["./", "./index.html", "./app.jsx?v=4", "./manifest.json", "./icons/icon-192.png", "./icons/icon-512.png"];
